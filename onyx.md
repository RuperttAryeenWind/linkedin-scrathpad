...
curli --insecure -i -H 'X-RestLi-Protocol-Version: 2.0.0' -H 'Accept:application/json' -H 'Content-Type:application/json' --fabric ei-ltx1 --dv-auth SELF --ic 'mik:' https://localhost:9443/onyx/api/onyxContent/urn%3Ali%3Amail%3AI6722746642543493120_500\?viewer\=urn%3Ali%3Amember%3A24695536
...
/urn:li:ucf:(urn:li:messagingMessage:2-MTU1OTY3MDkyMTMwMTA4MjMyMC0wMDEmMzU4ZjM5NWYtOTQ0Yi01NDNlLTgzNzEtN2IyM2RlZGE2ODdjXzAwMA==,urn:li:member:804194)
